# CLAUDE.md — Come lavoriamo (BlueHarbor)

Guida alla **collaborazione tra il team e Claude** per il progetto *Learning by Project* del corso ITS ICT Piemonte — **WSA (Web Solutions Architect)**.
